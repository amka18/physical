...
import {
  SI_PredictVelocities,
  SI_SolveGroundCollision,
  SI_SolveObjectsCollision,
  SI_UpdatePositionAndRotation,
} from "./sequential_impulses.js";
...
export default class Simulation2 {
  ...
  update(dt) {
    ...
    for (let i = 0; i < this.subStepCount; i++) {
      ...
      for (const obj of this.objects) {
        SI_UpdatePositionAndRotation(obj, h);
      }
    }
  }
